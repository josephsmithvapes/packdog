  ...
  useEffect(() => {
    ...
    style.textContent = `
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .nav-link { font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; letter-spacing: 0.12em; text-transform: uppercase; color: #f5ede0; text-decoration: none; cursor: pointer; transition: color 0.2s; }
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#f5ede0", minHeight: "100vh" }}>
        ...
        <div style={{ display: "flex", animation: "ticker 20s linear infinite", whiteSpace: "nowrap" }}>
          {[...Array(4)].map((_, ri) => (
            <span key={ri} style={{ display: "flex", gap: 40, paddingRight: 40 }}>
              {["🐕 Adventure dog gear", "🚗 Free shipping over $50", "⚡ Ships in 5-8 days", "🏔 Trail & road tested", "✓ 30-day guarantee", "🐾 10% to Best Friends Animal Society"].map((t, i) => (
      ...
      <div style={{ background: "#091509", padding: "60px 24px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontFamily: "'Lora'", fontSize: 15, color: "#c8d4b080", marginBottom: 32 }}>Dogs in cars. Trail content. Zero fluff.</p>
          <button className="btn-primary" style={{ marginTop: 8 }}>FOLLOW FOR DOG CONTENT</button>
        </div>
      </div>
